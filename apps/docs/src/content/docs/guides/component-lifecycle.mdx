...
<StatusBadge status="beta" version="1.0.0-beta.2" since="1.0.0-beta.1" />
...
<StatusBadge status="alpha" version="0.5.0-alpha.1" />
...
## Reading Component Status

Each component documentation page displays its current status at the top:
...
This tells you:
- **Status**: Current maturity level (stable, beta, alpha, draft, deprecated)
