...
<div class="component-preview dark preview-row" style="align-items: flex-end; gap: 32px;">
  <div class="size-demo">
...
<style>{`
  ...
  /* Light theme */
  .theme-panel.light .hex-line.yang {
    background: #2a2520;
  }

  .theme-panel.light .hex-line.yin {
    background: linear-gradient(90deg,
      #2a2520 0%,
      #2a2520 37.5%,
      transparent 37.5%,
  ...
  .theme-panel.light .hex-line.changing {
