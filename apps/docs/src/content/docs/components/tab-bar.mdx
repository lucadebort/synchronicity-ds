...
<style>{`
  ...
  .preview-content[data-theme="light"] .sync-tabbar {
    background: rgba(245, 242, 234, 0.95);
    border-top-color: #e0dcd0;
  }

  .preview-content[data-theme="light"] .tab-label {
    color: #8a7f75;
  }

  .preview-content[data-theme="light"] .tab-label.active {
    color: #886a00;
  }

  .preview-content[data-theme="light"] .indicator.active {
    background: #886a00;
  }

  .preview-content[data-theme="true-black"] .sync-tabbar {
