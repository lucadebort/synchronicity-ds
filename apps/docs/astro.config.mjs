					...
					items: [
						...
						},
						{
							...
							items: [
								...
								{ label: 'TrigramCard', slug: 'components/trigram-card' },
								{ label: 'TrigramDrawingCanvas', slug: 'components/trigram-drawing-canvas' },
								{ label: 'ReadingListItem', slug: 'components/reading-list-item' },
							],
						},
					],
				},
